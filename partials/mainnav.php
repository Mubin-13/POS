        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right dropdown-content wmin-md-350">
              ...
              <ul class="media-list">
                ...
                <li class="media">
                  ...
                  <div class="media-body">
                    ...
                    <span class="font-weight-semibold">SYNTEX SQUAD</span>
                    repository
                    <div class="font-size-sm text-muted mt-1">
                      2 hours ago
                    </div>
            ...
            <div class="dropdown-content-footer bg-light">
              <a href="#" class="font-size-sm line-height-sm text-uppercase font-weight-semibold text-grey mr-auto">All
                activity</a>
              <div>
