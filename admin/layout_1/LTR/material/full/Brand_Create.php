        ...
        <div class="row">
          <form action="brand_create_processor.php" method="get" class="col-lg-12 col-sm-6 col-12 row">
            ...
            <div class="d-flex justify-content-start align-item-center">
              ...
              <button type="submit" class="btn btn-outline  ml-3  bg-success btn-icon text-success border-success border-2 rounded-round">Submit <i class="icon-arrow-up-right32"></i> </button>
            </div>
          </form>
        </div>
      </div>
